...
create_proj_card(
  img_src = "images/Premier League.png",
  url = "https://public.tableau.com/app/profile/stephan.teodosescu/viz/2021-22PremierLeague_16503505579010/PremierLeague
",
  title = "Tableau: Premier League Dashboard",
  text = "Current Premier League standings and statistics dashboard built in Tableau Public.",
  text2 = NULL
)
